...
- Now supports gamepad commands like `mandoBotonPresionado`.

## 🔍 Deteção de Erros Melhorada
O Carl e o motor trabalham agora em conjunto para te ajudar a programar:
- **Resumo em Tempo Real:** O editor deteta erros enquanto escreves.
- **Auto-Reparação:** O Carl pode analisar erros de execução e propor correções automáticas.
- **Consola Inteligente:** Erros categorizados com navegação direta para o código.
