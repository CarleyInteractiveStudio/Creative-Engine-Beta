...
### Настройки проекта
Перейдите в **Правка > Настройки проекта**, чтобы:
- Изменить название и автора игры.
- Управлять **Sorting Layers** (порядок отрисовки слоев).
- Определить **Collision Layers** и **Теги**.
