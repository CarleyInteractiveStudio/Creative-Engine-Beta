...
document.addEventListener('DOMContentLoaded', () => {
    ...
    updateCanvasInteractivity = async function() {
        ...
        if (!renderer3D) {
            ...
            window.gameCarleyWorld = new CarleyWorld(dom.gameCanvas3d);
        }
    ...
    updateScene = function(rendererInstance, isGameView) {
        ...
        const handleRender = (camera) => {
            ...
            if (!isGameView) {
                ...
                const active3D = window._Renderer3D || renderer3D;
                SceneView.drawOverlay(active3D?.lastProjectionMatrix, active3D?.lastViewMatrix);
            }
