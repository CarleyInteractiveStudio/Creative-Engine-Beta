...
export class PhysicsSystem {
    ...
    checkCollision(materiaA, materiaB) {
        ...
        if (colliderA constructor.name === "BoxCollider2D") {
            if (colliderB constructor.name === "BoxCollider2D") {
                collisionInfo = this.isBoxVsBox(materiaA, materiaB);
            } else if (colliderB constructor.name === "CircleCollider2D") {
            ...
            } else if (colliderB constructor.name === "CapsuleCollider2D") {
                collisionInfo = this.isBoxVsCapsule(materiaA, materiaB);
            } else if (colliderB constructor.name === "PolygonCollider2D") {
                collisionInfo = this.isPolygonVsPolygon(materiaA, materiaB);
            } else if (colliderB constructor.name === "TilemapCollider2D" || colliderB constructor.name === "TerrenoCollider2D") {
                collisionInfo = this.isColliderVsTilemap(materiaA, materiaB);
            } else if (colliderB constructor.name === "LineCollider2D") {
                collisionInfo = this.isColliderVsLine(materiaA, materiaB);
            }
        } else if (colliderA constructor.name === "CircleCollider2D") {
            if (colliderB constructor.name === "CircleCollider2D") {
                collisionInfo = this.isCircleVsCircle(materiaA, materiaB);
            } else if (colliderB constructor.name === "BoxCollider2D") {
        ...
        } else if (colliderA constructor.name === "CapsuleCollider2D") {
            if (colliderB constructor.name === "BoxCollider2D") {
        ...
        } else if (colliderA constructor.name === "PolygonCollider2D") {
            if (colliderB constructor.name === "BoxCollider2D") {
                collisionInfo = this.isPolygonVsPolygon(materiaA, materiaB);
            } else if (colliderB constructor.name === "CircleCollider2D") {
        ...
        } else if (colliderA constructor.name === "TilemapCollider2D" || colliderA constructor.name === "TerrenoCollider2D") {
            if (colliderB constructor.name === "BoxCollider2D" || colliderB constructor.name === "CircleCollider2D" || colliderB constructor.name === "CapsuleCollider2D" || colliderB constructor.name === "PolygonCollider2D") {
        ...
        } else if (colliderA constructor.name === "LineCollider2D") {
    ...
    resolveCollision(materiaA, materiaB, collisionInfo) {
        ...
        const getInertia = (materia, rb) => {
            ...
            const transform = materia.getComponent(Components.Transform);
            let w = 50, h = 50;
            if (collider constructor.name === "BoxCollider2D" || collider constructor.name === "CapsuleCollider2D") {
                w = collider.size.x * (transform ? Math.abs(transform.scale.x) : 1);
                h = collider.size.y * (transform ? Math.abs(transform.scale.y) : 1);
            } else if (collider constructor.name === "CircleCollider2D") {
    ...
    isColliderVsTilemap(colliderMateria, tilemapMateria) {
        ...
        for (const rect of tilemapCollider.generatedColliders) {
            ...
            let collisionInfo = null;
            if (otherCollider constructor.name === "BoxCollider2D") {
                collisionInfo = this.isBoxVsBox(colliderMateria, this._tempPartMateria);
            } else if (otherCollider constructor.name === "CircleCollider2D") {
                collisionInfo = this.isCircleVsBox(colliderMateria, this._tempPartMateria);
            } else if (otherCollider constructor.name === "CapsuleCollider2D") {
            ...
            } else if (otherCollider constructor.name === "PolygonCollider2D") {
    ...
    isPolygonVsCapsule(polyMateria, capsuleMateria) {
        ...
        const vertices = (colliderP constructor.name === "PolygonCollider2D") ?
    ...
    isPolygonVsPolygon(materiaA, materiaB) {
        ...
        const verticesA = (colliderA constructor.name === "PolygonCollider2D") ?
            this._getPolygonVertices(transformA, colliderA) :
            this._getVertices(transformA, colliderA);
        const verticesB = (colliderB constructor.name === "PolygonCollider2D") ?
    ...
    raycast(origin, direction, maxDistance = Infinity, filter = null) {
        ...
        for (const materia of collidables) {
            ...
            } else if (collider constructor.name === "LineCollider2D") {
                hit = this._rayVsLine(origin, direction, transform, collider);
            } else if (collider constructor.name === "TilemapCollider2D" || collider constructor.name === "TerrenoCollider2D") {
