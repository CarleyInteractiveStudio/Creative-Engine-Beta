...
const availableComponents = {
    ...
    'UI': [Components.UIPosition, Components.UICanvas, Components.UIImage],
...
async function updateInspectorForMateria(selectedMateria) {
    ...
    const componentIcons = {
        ...
        UIPosition: '⚚', UICanvas: '🖼️', UIImage: '🏞️', PointLight2D: '💡', SpotLight2D: '🔦', FreeformLight2D: '✏️', SpriteLight2D: '🎇',
        Grid: '▦', Gizmo: '🎨'
    };
    ...
    selectedMateria.leyes.forEach((ley, index) => {
        ...
        if (ley instanceof Components.TextureRender) {
            ...
            const previewImg = ley.sprite && ley.sprite.src ? `<img src="${ley.sprite.src}" alt="Preview">` : 'None';
            componentHTML = `
            <div class="component-header">${iconHTML}<h4>UI Image</h4></div>
            <div class="component-content">
                <div class="inspector-row">
                    <label>Source</label>
                    <div class="asset-dropper" data-component="UIImage" data-prop="sprite" data-asset-type=".png,.jpg,.jpeg" title="Arrastra un asset de imagen aquí">
                        <div class="sprite-preview">${previewImg}</div>
                    </div>
                </div>
                <div class="prop-row-multi">
                    <label>Color</label>
                    <input type="color" class="prop-input" data-component="UIImage" data-prop="color" value="${ley.color}">
                </div>
                <div class="prop-row-multi">
                    <label>Opacity</label>
                    <input type="range" class="prop-input" data-component="UIImage" data-prop="opacity" min="0" max="1" step="0.01" value="${ley.opacity}">
                </div>
            </div>`;
