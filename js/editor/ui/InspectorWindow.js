        ...
        if (ley instanceof Components.TextureRender) {
            ...
            componentHTML = `
                ...
                <div class="component-content">
                    ...
                    <div class="prop-row-multi">
                        <label>Width</label>
                        <input type="number" class="prop-input" data-component="UIImage" data-prop="width" value="${ley.width}">
                    </div>
                    <div class="prop-row-multi">
                        <label>Height</label>
                        <input type="number" class="prop-input" data-component="UIImage" data-prop="height" value="${ley.height}">
                    </div>
                    <div class="prop-row-multi">
                        <label>Opacity</label>
